...
class NWRigSystem:
        ...
        def blueprintMode(self):
                ...
                """
                if self.state == BLUEPRINT_STATE:
                        print "Already in blueprint mode."
                        return
                ...
                # Build blueprints from default file if scene empty        
                if self.rootExists():
                        modules = self.getModules()
                        for module in modules:
        ...
        def rigMode(self):
                ...
                """
                if self.state == RIG_STATE:
                        print "Already in rig mode. \n"
                        return
