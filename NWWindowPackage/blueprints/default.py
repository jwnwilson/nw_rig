...
rigRenameButton = window.button({'key':'rigRenameButton','parent':rigForm, 'label':'rename module'},width= 100)
rigDeleteButton = window.button({'key':'rigDeleteButton','parent':rigForm, 'label':'delete module'},width= 100)
