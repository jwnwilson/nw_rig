...
class Layout(Element):
    def initialize(self,**kwargs):
        ...
        self.RigInstance = Util.checkForKwarg("rigInstance",kwargs)
...
class Window:
    ...
    def __init__(self, args, **kwds):
        ...
        #default args
        self.windowParamters = { "name":"window", "windowWidth":400, "windowHeight":400, "title":"Window", "window":""}
        #overwrite defaults
    ...
    def initialiseWindow(self, **kwds):
        """
            Initialise window
        """
        functArgs =  Util.defaultArgs( {"windowHeight":400, "windowWidth":400, "title":"Window", "sizeable":True} , self.windowParamters)
    ...
    def inputExists(self, input):
        ...
        if self.inputs.has_key(input):
            ...
            cmds.error( "Input :" + input + " not found" )
            return True
    ...
    def createValueWindow(self, message, defaultValue, command ):
        ...
        """
        # Create window
        self.valueWindow = Window({"name":"valueWindow", "windowWidth":200, "windowHeight":100, "title":"WindowValue", "Rig":self},s = False)
        self.valueWindow.windowParamters["sizeable"] = False
        # Root layout
    ...
    def createPromptWindow(self, message, command):
        ...
        """
        # Create window
        self.promptWindow = Window({"name":"promptWindow", "windowWidth":200, "windowHeight":100, "title":"Are you sure?", "Rig":self})
